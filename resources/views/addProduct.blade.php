            ...
            <div class="container">
                <form class="row g-3" action="/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="price" value="{{old('price')}}" class="form-control" id="inputPrice"
                               placeholder="Rs.100">
                        <span style="color: red">@error('price'){{$message}}@enderror</span>
                    </div>
                    <div class="col-md-1">
                        <label for="inputQty" class="form-label" style="color: white">Quantity</label>
                        <input type="number" min="1" max="" name="qty" value="{{old('qty')}}" class="form-control"
                               id="inputQty" placeholder="123">
